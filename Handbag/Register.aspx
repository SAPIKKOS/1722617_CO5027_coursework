<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Handbag.Register" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
     ...
     <h2>
        ...
        <div>
            ...
            <asp:Literal ID="LiteralOne" runat="server"></asp:Literal>
        </div>
        <div>
            <h2>
                Login</h2>
            ...
            <div>
                <asp:Literal ID="LiteralTwo" runat="server"></asp:Literal>
            </div>
        </div>
